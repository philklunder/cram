...
export function SetupNotice() {
  return (
    <div className="mx-auto mt-24 max-w-lg px-4">
      <div className="rounded-2xl border border-amber-200 bg-amber-50 p-6 text-sm text-amber-900 shadow-card">
        ...
        <p className="mt-3">
          ...
          <code className="rounded bg-amber-100 px-1 py-0.5">.env.local</code> and set:
        </p>
        <ul className="mt-2 space-y-1">
          <li>
            <code className="rounded bg-amber-100 px-1 py-0.5">NEXT_PUBLIC_SUPABASE_URL</code>
          </li>
          <li>
        ...
        <p className="mt-3">
          ...
          <code className="rounded bg-amber-100 px-1 py-0.5">web/README.md</code>.
        </p>
      </div>
    </div>
  );
